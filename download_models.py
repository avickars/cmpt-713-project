...
def main():
    # Downloading Bert
    download_and_move_model(gdrive_id="18RKwRiWW0hPEBdUxeUxW359SXHKXOYbp", name="bert-base-uncased_4000_0.pt", destination="bert/checkpoints")
    download_and_move_model(gdrive_id="18RKwRiWW0hPEBdUxeUxW359SXHKXOYbp", name="lstm-base-uncased_4000_0_best.h5", destination="lstm/checkpoints")
